export const explode = function() {
  let canvas;
  let stage;
  let imgSeq = new Image();       // The image for the sparkle animation
  let sprite;                     // The animated sparkle template to clone
  let fpsLabel;
  let fader;                      // Semi fades the Background to give a tracing effect
  let spkls;                      // Container for all the sparkles
  function init() {
